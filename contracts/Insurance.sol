...
contract Insurance is IInsurance, Ownable, MainDemoConsumerBase {
    ...
    function createPolicy(uint256 insuredAmount, uint256 duration) public returns (uint256 policyId) {
        uint256 price = (insuredAmount * policyPriceAPR * duration) / (YEAR_DURATION * 100);
        ...
        treasuryToken.transferFrom(msg.sender, address(this), price);
